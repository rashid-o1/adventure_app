...
import '../controller/signup_otp_verification_controller.dart';
...
class SignupOTPVerificationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // argument
    final SignupOTPVerificationController controller = Get.put(
      SignupOTPVerificationController(isForgotPasswordFlow: isForgotPasswordFlow),
    );
